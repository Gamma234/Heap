...
template<class Type>
FibonacciHeap<Type> * BuildHeapAndUnion( FibonacciHeap<Type> * sourceHeap, Type * dataPtr, int size,
                                         bool ( *compare ) ( Type data1, Type data2 ) ) ;
...
void UnionEachFileTest( string path, vector<string> fileNameBox ) {
    ...
    */
    ...
    Data * dataPtr = NULL ;
    bool printOnScreen = false ;
    FibonacciHeap<int> * intHeap = NULL ;
    FibonacciHeap<Data> * dataHeap = NULL ;
...
void BuildHeapAndSort( Type * dataPtr, int size,
    ...
    FibonacciHeap<Type> * heap = new FibonacciHeap<Type>( compare ) ;
