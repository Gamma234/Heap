...
template<class Type>
LeftistHeap<Type>* BuildHeapAndUnion( LeftistHeap<Type>* sourceHeap, Type* dataPtr, int size,
                                      bool ( *compare ) ( Type data1, Type data2 ) ) ;
...
void UnionEachFileTest( string path, vector<string> fileNameBox ) {
  ...
  */
  ...
  Data* dataPtr = NULL ;
  bool printOnScreen = false ;
  LeftistHeap<int>* intHeap = NULL ;
  LeftistHeap<Data>* dataHeap = NULL ;
...
void BuildHeapAndSort( Type* dataPtr, int size,
  ...
  LeftistHeap<Type>* heap = new LeftistHeap<Type>( compare ) ;
